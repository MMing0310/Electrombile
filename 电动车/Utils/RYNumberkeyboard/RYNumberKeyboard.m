...
- (id)init
{
    ...
    {
        // 添加keyboardview
        self.frame = CGRectMake(0, 0, SYS_DEVICE_WIDTH, 336);
        [[NSBundle mainBundle] loadNibNamed:@"RYNumberKeyboard" owner:self options:nil];
        self.keyboardView.frame = self.frame;
        [self addSubview:self.keyboardView];
        self.numberTF.layer.borderColor = [UIColor colorWithHexString:@"FECF42"].CGColor;
        self.configBtn.backgroundColor = [UIColor colorWithHexString:@"FECF42"];
        // 设置图片
